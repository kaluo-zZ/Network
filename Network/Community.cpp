...
Graph* Community::partition2graph_binary() {
	...
	g2->degrees = (int *)malloc(comm_nodes.size() * sizeof(int));
	g2->links = (int *)malloc((long)100000 * 2 * sizeof(int));
	g2->weights = (int *)malloc((long)100000 * 2 * sizeof(int));
	...
	realloc(g->links, (long)g2->nb_links * sizeof(int));
	realloc(g->weights, (long)g2->nb_links * sizeof(int));
